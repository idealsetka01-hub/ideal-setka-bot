...
# ---- To'lov ma'lumotlari ----
# Naqd pul (CASH) to'lov tizimidan olib tashlangan — endi faqat online to'lovlar mavjud.
PAY_QR = "YAGONA QR-KOD"
PAY_CLICK = "CLICK"
PAY_PAYME = "PAYME"

PAY_CODE_TO_NAME = {"QR": PAY_QR, "CLICK": PAY_CLICK, "PAYME": PAY_PAYME}
...
QR_PAYLOAD = (
    ...
    "655802UZ5921IDEAL INTER FARM MCHJ6007ANDIJON80320012qr-online.uz031299897473722163045B37"
)
